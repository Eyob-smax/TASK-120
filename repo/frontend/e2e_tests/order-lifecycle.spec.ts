...
test.describe("Order lifecycle", () => {
  test("create order with line items shows order in list with Reserved status", async ({
    page,
  }) => {
  ...
  test("cancel order releases reservations and updates status", async ({
    page,
  }) => {
  ...
  test("release expired reservations shows count toast", async ({ page }) => {
    ...
    await expectToast(page, "Released");
  });
